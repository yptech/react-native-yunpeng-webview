...
NSString *const RNJSNavigationScheme = @"react-js-navigation";
...
- (void)setSource:(NSDictionary *)source
{
  if (![_source isEqualToDictionary:source]) {
    ...
    if (html) {
      ...
      if (_userAgent != nil) {
          NSMutableDictionary* msource = [NSMutableDictionary dictionaryWithDictionary:source];
          NSMutableDictionary *headers = [NSMutableDictionary dictionaryWithDictionary:msource[@"headers"]];
          [headers setValue:_userAgent forKey:@"User-Agent"];
          [msource setValue:headers forKey:@"headers"];
          source = [msource copy];
      }
    
    NSMutableURLRequest *request = (NSMutableURLRequest *)[RCTConvert NSURLRequest:source];
    ...
    NSString *source = [NSString stringWithFormat:
      @"(function() {"
        ...
        "document.addEventListener('message:received', function(e) {"
          ...
          "processQueue();"
        "});"
      "})();", RNJSNavigationScheme, kPostMessageHost
    ];
