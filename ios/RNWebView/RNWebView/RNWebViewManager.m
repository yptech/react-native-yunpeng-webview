...
RCT_EXPORT_METHOD(goBack:(nonnull NSNumber *)reactTag)
{
  [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNWebView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[RNWebView class]]) {
      RCTLogError(@"Invalid view returned from registry, expecting RNWebView, got: %@", view);
    } else {
      [view goBack];
    }
  }];
...
- (BOOL)webView:(__unused RNWebView *)webView
